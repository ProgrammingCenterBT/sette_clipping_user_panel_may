...
@Component({
  selector: 'app-radar-timeline',
  templateUrl: './radar-timeline.component.html',
  styleUrls: ['./radar-timeline.component.css']
})
export class RadarTimelineComponent {
  ...
  ngAfterViewInit() {
    ...
    this.browserOnly(() => {
      ...
      let div = document.getElementById("chartdiv4");
      ...
      function updateRadarData(year) {
        if (currentYear != year) {
         ...
         let exporting = am5plugins_exporting.Exporting.new(root, {
          ...
          filePrefix: "sette-radar-timeline",
            title: "Sette Analytics Radar Timeline",
            dataSource: data,
            pdfOptions: {
              includeData: true,
